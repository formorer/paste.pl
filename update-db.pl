...
my $dbname = $config->val('database', 'dbname') || die "Databasename not specified in config";
my $dbuser = $config->val('database', 'dbuser') || die "Databaseuser not specified in config";
